...
var renderAssets = require('./render-assets');
var renderPug = require('./render-pug');
var renderScripts = require('./render-scripts');
var renderSCSS = require('./render-scss');
...
var allPugFiles = {};
watcher.on('add', function (filePath) { return _processFile(filePath, 'add'); });
watcher.on('change', function (filePath) { return _processFile(filePath, 'change'); });
...
function _renderAllPug() {
    ...
    _.each(allPugFiles, function (value, filePath) {
        renderPug(filePath);
    });
}
